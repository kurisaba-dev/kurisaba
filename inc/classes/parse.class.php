...
class Parse {
    ...
    $replaces =  array(
      ...
      '<span class="spoiler">\\1</span>',
	  '<div class="cutspoiler" onclick="v=this.getElementsByClassName(\'cut\');if(v[0].style.display==\'none\'){v[0].style.display=\'\';v[1].style.display=\'none\';}else{v[1].style.display=\'\';v[0].style.display=\'none\';}"><span class="cut">Развернуть</span><span class="cut" style="display: none;">\\1</span></div>',
	  '<span class="cutspoiler" onclick="v=this.getElementsByClassName(\'cut\');if(v[0].style.display==\'none\'){v[0].style.display=\'\';v[1].style.display=\'none\';}else{v[1].style.display=\'\';v[0].style.display=\'none\';}"><span class="cut">Развернуть</span><span class="cut" style="display: none;">\\1</span></span>',
