...
function fillGeoblockForm(cr_post, cr_file, prop_post, prop_file, isthread)
{
	if(isthread)
	{
		$('#prop_post').show();
		$('#prop_file').show();
		$('#prop_post').prop('checked', cr_prop);
		$('#prop_file').prop('checked', crf_prop);
	}
	else
	{
		$('#prop_post').hide();
...
function readyset() {
  ...
  $('<div id="geoblockform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    ...
    '<input type="text" size="10" id="cr_post" name="cr_post" title="' + _.isocodes + '"><input type="checkbox" id="prop_post" name="prop_post" value="prop_post">&nbsp;' + _.propagate + '&nbsp;<input type="button" name="gbpost" title="' + _.geoblockpost + '" value="' + _.post + '" onclick="do_geoblock(false); return false;"><br />'+
    '<input type="text" size="10" id="cr_file" name="cr_file" title="' + _.isocodes + '"><input type="checkbox" id="prop_file" name="prop_file" value="prop_file">&nbsp;' + _.propagate + '&nbsp;<input type="button" name="gbfile" title="' + _.geoblockfile + '" value="' + _.file + '" onclick="do_geoblock(true); return false;"><br />'+
