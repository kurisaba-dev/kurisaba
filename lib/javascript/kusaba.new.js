...
var Settings = {
  ...
  smiliesMode: function(changed) {
    ...
    if (enabled) {
      ...
      addCSSRules(".smilies_tr { display: table-row; }", "smiliesModeOn0");
      addCSSRules(".smilies_div { display: block; }", "smiliesModeOn1");
      addCSSRules(".smilies_span { display: inline; }", "smiliesModeOn1");
    } else {
      delCSSRules("smiliesModeOn0");
      delCSSRules("smiliesModeOn1");
      delCSSRules("smiliesModeOn2");
      addCSSRules(".smilies_tr, .smilies_div, .smilies_span { display: none; }", "smiliesModeOff");
    }
	return enabled;
  },
...
var nph = {
	...
	hideDelBtn: function() {
		this.nameElem.style.width = "500px";
		this.btnElem.style.display = "none";
	},

	showDelBtn: function() {
		this.nameElem.style.width = "480px";
