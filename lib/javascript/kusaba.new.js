...
function readyset() {
  ...
  $('<div id="edittagsform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    ...
    '<input type="text" size="10" id="tf_tags" name="tf_tags" title="' + _.tftags + '">&nbsp;&nbsp;<input type="button" style="width: 50px;" name="tfapply" title="' + _.tfapplynote + '" value="' + _.tfapply + '" onclick="do_edittags(); return false;"><br />'+
