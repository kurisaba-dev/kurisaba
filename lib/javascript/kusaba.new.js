...
(function($) {
  ...
  $.fn.unwrap = function () {
    ...
    var embedHTMLs = {
      youtube: '<iframe style="display:none" class="embedded-content" width="368" height="237" src="//www.youtube.com/embed/'+vid+'?wmode=transparent'+(tcode===null?'':tcode)+'" frameborder="0" allowfullscreen></iframe>',
...
var embedLinks = {
  sites: [
    {id: 'youtube', rx: /[\w\W]*(?:youtu\.be\/|youtube\.com\/?\?v=)(.*)?/ },
