...
var notificationIcon =  ku_boardspath + "/images/notification.png?v="+ku_cssver;
...
function touhou_replaceAllText() {
  ...
  $('.logo').before('<center><img src="/images/cirno_banner.png?v='+ku_cssver+'"></center>');
...
var _messages = {
  en: {
    ...
    watchlistAdd: "Thread is now in the watchlist.",
    watchlistRemove: "Thread is removed from the watchlist.",
    ...
    settings_fullfeed: "Show all boards in feed",
    ...
    geobtn: "Geoblock",
    isocodes: "Enter ISO country codes (e.g. RU,US)",
    geoblockboth: "Geographically block this post and file",
    geoblockpost: "Geographically block this post",
    geoblockfile: "Geographically block this file",
    propagate: "All thread",
    both: "All",
    post: "Post",
    file: "File",
    tagbtn: "Edit tags",
    tftags: "Enter tags (may be not unique), separated by commas",
    tfapplynote: "Apply tags",
    tfapply: "Ok"
  },
  ru: {
    ...
    settings_fullfeed: "Показывать все доски в однопотоке",
    ...
    geobtn: "Геоблокировка",
    isocodes: "Введите ISO-коды стран (например: RU,US)",
    geoblockboth: "Заблокировать пост и файл в этих странах",
    geoblockpost: "Заблокировать пост в этих странах",
    geoblockfile: "Заблокировать файл в этих странах",
    propagate: "Весь тред",
    both: "Всё",
    post: "Пост",
    file: "Файл",
    tagbtn: "Править теги",
    tftags: "Введите теги (можно по нескольку раз) через запятую",
    tfapplynote: "Изменить теги",
    tfapply: "Ok"
  }
}
...
var Styles = {
  ...
  decide: function() {
    ...
    if(sc && in_array(sc, this.titles))
      ...
      this.setDefault();
      setCookie("kustyle2",this.default,365);
    }
  },
  change: function(stylename) {
    ...
    if(this.hasOwnProperty('custom') && this.custom === stylename) {
      ...
      if(this.hasOwnProperty('custom'))
        this.addBypass();
      setCookie("kustyle2",stylename,365);
    }
...
function delandbanlinks($scope, force)
{
    ...
    $scope.find('span[id^=dnb]').each(function(index,element)
    {
        ...
        if(!isthread)
        {
            newhtml += '<a href="#" onclick="editTags($(this), \''+boardname+'\', '+postid+'); return false;" title="'+_.tagbtn+'"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="edittags spritebtn sb-l"><\/a>';
            newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + boardname + '&delpostid=' + postid + '" title="'+_.delete+'" onclick="return confirm(\''+_.deletePost+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="delete spritebtn sb-c"><\/a>';
        }
        else
        {
            newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + boardname + '&delpostid=' + postid + '" title="'+_.delete+'" onclick="return confirm(\''+_.deletePost+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="delete spritebtn sb-l"><\/a>';
        }
        newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=delposts&do_ban=true&boarddir=' + boardname + '&delpostid=' + postid + '" title="'+_.delandban+'" onclick="return confirm(\''+_.deleteAndBan+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="dandb spritebtn sb-c"><\/a>';
        newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=bans&banboard=' + boardname + '&banpost=' + postid + '" title="'+_.ban+'" onclick="return confirm(\''+_.ban+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="ban spritebtn sb-c"><\/a>';
        if(kuadm_set && ku_offload)
        {
            newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=bans&ban_img_by_post=true&banboard=' + boardname + '&banpost=' + postid + '" title="'+_.banfile+'" onclick="return confirm(\''+_.banfile+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="banfile spritebtn sb-c"><\/a>';
            newhtml += '<a href="#" onclick="geoBlock($(this), \''+boardname+'\', '+postid+', '+isthread+'); return false;" title="'+_.geobtn+'"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="geoblock spritebtn sb-r"><\/a>';
        }
        else
        {
            newhtml += '<a href="' + ku_cgipath + '/manage_page.php?action=bans&ban_img_by_post=true&banboard=' + boardname + '&banpost=' + postid + '" title="'+_.banfile+'" onclick="return confirm(\''+_.banfile+'?\');"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="banfile spritebtn sb-r"><\/a>';
        }
        newhtml += '</span>&nbsp;';
        if (isthread)
        {
            newhtml += '<span class="btngroup"><a href="' + ku_cgipath + '/manage_page.php?action=stickypost&board=' + boardname + '&postid=' + postid + '" title="'+_.stickthread+'" ><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="stick spritebtn sb-l"><\/a><a href="' + ku_cgipath + '/manage_page.php?action=unstickypost&board=' + boardname + '&postid=' + postid + '" title="'+_.unstickthread+'" ><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="unstick spritebtn sb-r"><\/a></span>&nbsp;';
            newhtml += '<span class="btngroup"><a href="' + ku_cgipath + '/manage_page.php?action=lockpost&board=' + boardname + '&postid=' + postid + '" title="'+_.lockthread+'" ><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="lock spritebtn sb-l"><\/a><a href="' + ku_cgipath + '/manage_page.php?action=unlockpost&board=' + boardname + '&postid=' + postid + '" title="'+_.unlockthread+'" ><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="unlock spritebtn sb-r"><\/a></span>';
        }
        $(this).html(newhtml);
    });
}
...
var HiddenThreads = {
  list: function(boardname) {
    if (!window.localStorage) return [];
    var list = localStorage.getItem('hiddenThreads.' + boardname);
    if (list == null) return [];
    return list.split(',');
  },
  isHidden: function(boardname, threadid) {
    return HiddenThreads.list(boardname).indexOf(threadid) != -1
  },
  hide: function(boardname, threadid) {
    if (!window.localStorage) return;
    var newlist = HiddenThreads.list(boardname);
    newlist.push(threadid.toString());
    localStorage['hiddenThreads.' + boardname] = newlist.join(',');
  },
  unhide: function(boardname, threadid) {
    if (!window.localStorage) return;
    var list = HiddenThreads.list(boardname);
...
function togglethread(boardname, threadid) {
  if (HiddenThreads.isHidden(boardname, threadid)) {
    $('#unhidethread' + threadid + boardname).slideUp();
    $('#thread' + threadid + boardname).slideDown();
    HiddenThreads.unhide(boardname, threadid);
  } else {
    $('#unhidethread' + threadid + boardname).slideDown();
    $('#thread' + threadid + boardname).slideUp();
    HiddenThreads.hide(boardname, threadid);
  }
  return false;
}
...
function expandthread(threadid, board) {
  if ($('#replies' + threadid + board).get() != '') {
    $('#replies' + threadid + board).prepend("<img src=\""+ku_boardspath+"/images/loading16x16.gif?v="+ku_cssver+"\" style=\"vertical-align: text-bottom;\" /> " + _.expandingThread + '<br />');
    $.ajax({
...
function process_hiders()
{
	hiders = document.querySelectorAll(".hider");
	if (hiders.length > 0)
	{
		hiders.forEach((h) =>
		{
			var id;
			h.classList.forEach((cl) => {if (cl.includes("id_")) id = cl;})
			if(h.classList.contains("bythreadid"))
			{
				h.hidden = false;
			}
			if(h.classList.contains("bypostid"))
			{
				h.hidden = !(document.querySelector(".hider.bythreadid."+id) == null);
			}
			if(h.classList.contains("byparentid"))
			{
				h.hidden = !(document.querySelector(".hider.bythreadid."+id) == null && document.querySelector(".hider.bypostid."+id) == null);
			}
			if(h.classList.contains("byauthor"))
			{
				h.hidden = !(document.querySelector(".hider.bythreadid."+id) == null && document.querySelector(".hider.bypostid."+id) == null && document.querySelector(".hider.byparentid."+id) == null);
			}
			if(h.classList.contains("byword"))
			{
				h.hidden = !(document.querySelector(".hider.bythreadid."+id) == null && document.querySelector(".hider.bypostid."+id) == null && document.querySelector(".hider.byparentid."+id) == null && document.querySelector(".hider.byauthor."+id) == null);
			}
		});
	}
}

function hide_unwanted_posts()
{
	if (typeof localStorage['hidden_posts']   === 'undefined') localStorage['hidden_posts']   = '[]';
	if (typeof localStorage['hidden_authors'] === 'undefined') localStorage['hidden_authors'] = '[]';
	...
	var process_posts = document.querySelectorAll("td.reply, td.op");

	// Hide posts hidden by id
	hiddenposts.forEach((post_to_hide) =>
	{
		var b = post_to_hide.board;
		var p = post_to_hide.post;
		document.querySelectorAll('#reply' + p).forEach((post) =>
		{
			var post_b = post.querySelector(".span_board_name").innerHTML;
			if(post_b == b && !post.classList.contains("hiddenbypostid"))
			{
				post.classList.add("hiddenbypostid")
				patch = document.createElement("td");
				patch.setAttribute("id","reply"+p+b+"hiddenbyid");
				patch.classList.add("hider");
				patch.classList.add("bypostid");
				patch.classList.add("id_" + p + "_" + b);
				patch.innerHTML = "Пост "+b+"/"+p+" скрыт по номеру. Показать вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidepost_num('"+b+"',"+p+");return false;\" title=\"Показать этот пост\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать этот пост\" /></a>";
				post.after(patch);
			}
		});
	});

	// Hide threads hidden by id, and their sub-posts, if we're in feed
	Object.keys(localStorage).forEach((data) =>
	{
		if (data.substr(0,14) == "hiddenThreads.")
		{
			var b = data.replace("hiddenThreads.","")
			if (localStorage[data].split(",").length > 0)
			{
				localStorage[data].split(",").forEach((p) =>
				{
					if (p != "")
					{
						document.querySelectorAll('#reply' + p).forEach((post) =>
						{
							var post_b = post.querySelector(".span_board_name").innerHTML;
							if(post_b == b && !post.classList.contains("hiddenbythreadid"))
							{
								post.classList.add("hiddenbythreadid")
								patch = document.createElement("td");
								patch.setAttribute("id","thread"+p+b+"hiddenbyid");
								patch.classList.add("hider");
								patch.classList.add("bythreadid");
								patch.classList.add("id_" + p + "_" + b);
								patch.innerHTML = "Тред "+b+"/"+p+" скрыт по номеру. Показать вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidethread_num('"+b+"',"+p+");return false;\" title=\"Показать этот тред\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать этот тред\" /></a>";
								post.after(patch);
							}
						});
						if (typeof(isfeed) != "undefined" && isfeed)
						{
							document.querySelectorAll('.reply_parent' + p).forEach((post) =>
							{
								var a = post.id.replace("reply","");
								var post_b = post.querySelector(".span_board_name").innerHTML;
								if(post_b == b && !post.classList.contains("hiddenbyparentid"))
								{
									post.classList.add("hiddenbyparentid")
									patch = document.createElement("td");
									patch.setAttribute("id","thread"+p+b+"hiddenbyid");
									patch.classList.add("hider");
									patch.classList.add("byparentid");
									patch.classList.add("id_" + a + "_" + b);
									patch.innerHTML = "Пост "+b+"/"+a+" скрыт, так как тред "+b+"/"+p+" скрыт по номеру. Показать вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidethread_num('"+b+"',"+p+");return false;\" title=\"Показать этот тред\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать этот тред\" /></a>";
									post.after(patch);
								}
							});
						}
	...
	// Unhide and hide posts hidden by author
	process_posts.forEach((post) =>
	{
		var b;
		post.classList.forEach((cl) => {if (cl.includes("reply_board_")) b = cl.replace("reply_board_","");})
		var author = post.querySelector(".hideablename").innerHTML;
		if(document.querySelectorAll('#' + post.id + "_" + b + "hiddenbyauthor").length > 0)
		{
			if (!in_array(author, hiddenauthors))
			{
				post.classList.remove("hiddenbyauthor");
				hider = document.querySelector('#' + post.id + "_" + b + 'hiddenbyauthor');
		...
		else
		{
			if (in_array(author, hiddenauthors))
			{
				var p = post.querySelector("input.stchkbox").value;
				post.classList.add("hiddenbyauthor");
				patch = document.createElement("td");
				patch.setAttribute("id", post.id + "_" + b + "hiddenbyauthor");
				patch.classList.add("hider");
				patch.classList.add("byauthor");
				patch.classList.add("id_" + p + "_" + b);
				patch.innerHTML = "Пост " + b + "/" + p + ", написанный " + author + ", скрыт по автору. Показать его посты вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidepost_author('" + author + "');return false;\" title=\"Показать посты\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать посты\" /></a>";
				post.after(patch);
			}
		}
	})

	// Unhide and hide posts hidden by words
	if (hiddenwords.length > 0)
	{
		process_posts.forEach((post) =>
		{
			var b;
			post.classList.forEach((cl) => {if (cl.includes("reply_board_")) b = cl.replace("reply_board_","");})
			var hiddenwords_found = 0;
			var actual_hiddenword = '';
			hiddenwords.forEach((hiddenword) =>
			{
				if (hiddenword.trim() != '')
				{
					if (post.querySelector('blockquote').textContent.toLocaleLowerCase().indexOf(hiddenword.toLocaleLowerCase()) > -1)
					{
			...
			if (hiddenwords_found > 0)
			{
				var patch;
				var p = post.querySelector("input.stchkbox").value;
				if (document.querySelectorAll('#' + post.id + "_" + b + "hiddenbyword").length == 0)
				{
					post.classList.add("hiddenbyword");
					patch = document.createElement("td");
					patch.setAttribute("id", post.id + "_" + b + "hiddenbyword");
					patch.classList.add("hider");
					patch.classList.add("byword");
					patch.classList.add("id_" + p + "_" + b);
					patch.innerHTML = "Пост " + b + "/" + p + " скрыт по слову &laquo;"+actual_hiddenword+"&raquo;" + ((hiddenwords_found > 1) ? " и еще " + (hiddenwords_found - 1) + " другим словам" : "") + ". Показать посты с этими словами вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidepost_text('"+actual_hiddenword+"');return false;\" title=\"Показать посты\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать посты\" /></a>";
					post.after(patch);
				}
				else
				{
					patch = document.querySelector("#" + post.id + "_" + b + "hiddenbyword");
					patch.innerHTML = "Пост " + b + "/" + p + " скрыт по слову &laquo;"+actual_hiddenword+"&raquo;" + ((hiddenwords_found > 1) ? " и еще " + (hiddenwords_found - 1) + " другим словам" : "") + ". Показать посты с этими словами вновь: <a class=\"extrabtns\" href=\"#\" onclick=\"unhidepost_text('"+actual_hiddenword+"');return false;\" title=\"Показать посты\"><img src=\"/css/icons/blank.gif?v="+ku_cssver+"\" border=\"0\" class=\"unhidethread spritebtn\" alt=\"Показать посты\" /></a>";
				}
			}
			else
			{
				if (document.querySelectorAll('#' + post.id + "_" + b + "hiddenbyword").length > 0)
				{
					post.classList.remove("hiddenbyword");
					hider = document.querySelector('#' + post.id + "_" + b + 'hiddenbyword');
					if (hider) hider.remove();
				}
			}
		})
...
function getPostByNum(board, postnum)
{
	return document.querySelector('#reply' + postnum + '.reply_board_' + board);
}
...
function hide_poster(name)
{
	...
	var hiddenauthors = JSON.parse(localStorage['hidden_authors']);
	if (!hiddenauthors.includes(name)) hiddenauthors.push(name);
...
{
	document.querySelectorAll("#reply"+post+board+"hiddenbyid").forEach((s) => {s.remove()});
	if (!localStorage.getItem('hidden_posts')) localStorage['hidden_posts'] = '[]';
	...
	hiddenposts.forEach(
		function(item, i, arr)
		{
			...
			{
				arr.splice(i, 1);
				document.querySelectorAll('#reply'+post+'.reply_board_'+board).forEach((s) =>
				{
					s.classList.remove("hiddenbypostid");
				});
			}
		}
	);
...
function hidethread_num(board, post)
{
	if (!localStorage.getItem('hiddenThreads.'+board)) localStorage['hiddenThreads.'+board] = '';

	var hiddenposts = localStorage['hiddenThreads.'+board].split(",");
	hiddenposts.push(post);
	localStorage['hiddenThreads.'+board] = hiddenposts.join(",");

	hide_unwanted_posts();
	return false;
}

function unhidethread_num(board, post)
{
	document.querySelectorAll("#thread"+post+board+"hiddenbyid").forEach((s) => {s.remove()});
	if (!localStorage.getItem('hiddenThreads.'+board)) localStorage['hiddenThreads.'+board] = '';
	...
	hiddenposts.forEach(
		function(item, i, arr)
		{
			if (item == post)
			{
				...
				document.querySelectorAll('#reply'+post+'.reply_board_'+board).forEach((s) =>
				{
					s.classList.remove("hiddenbythreadid");
				});
				document.querySelectorAll('.reply_parent'+post+'.reply_board_'+board).forEach((s) =>
				{
					s.classList.remove("hiddenbyparentid");
				});
			}
		}
	);
...
function expand_post(element, board, threadid, postid)
{
	...
	abbrev.innerHTML = '<img src="'+ku_boardspath+'/images/loading16x16.gif?v='+ku_cssver+'" style="vertical-align: text-bottom;" /> Разворачиваю пост...';
...
function start_deletion(plural, postlist, delformd, errors)
{
	...
	xhr.onreadystatechange = function() {
		if (xhr.readyState != 4)
			return;
		if (xhr.status != 200) {
			if(Settings.postingMode(false)) { getnewposts(undefined,true,true,false,true); }
		...
		if (Settings.postingMode(false)) {
			getnewposts(undefined,true,true,false,true);
			window.location.replace(responseUrl);
		} else {
			window.location.replace(responseUrl);
...
function getnewposts(threadid, automatic, notutturu, noredirect, silent) {
	var isfeed = ($('.isfeed').length > 0);
	if (dollchanEnabled)
		return false;
	autoRefreshTmpPrevent();
...
if(isfeed)
{
	fetch(ku_cgipath + '/single.php').then(response =>
	{
		autoRefreshRestore();

		if (response.status !== 200) {
			if (!silent) {
				popupMessageHttpError(response.status, response.statusText);
			}
			return false;
		}
	...
	{
		newDocument = (new DOMParser()).parseFromString(responseText, "text/html");

		// Count new posts
		var res_count = 0;
		newDocument.querySelectorAll('table.postnode').forEach(elem =>
		{
			elem.querySelectorAll('td.op,td.reply').forEach(td =>
			{
				if (document.querySelectorAll('#'+td.id+'.'+td.classList.toString().replaceAll(' ','.')).length == 0) ++res_count;
			});
		});

		// We completely update the replies block with newly arrived data. It may not be most effective way, but feed usually is not so long, and this lets us avoid all this mess with reply maps.
		document.querySelector('td.content-background').innerHTML = newDocument.querySelector('td.content-background').innerHTML;

		// Notify on new posts if automatic refresh
		if (res_count > 0 && automatic) {
			...
			if (Settings.pushNotify(false)) {
				notificationSend("Однопоток", _.newReplies + ": " + res_count);
			}
		}
		...
		if (res_count > 0) tasksAfterModify();

		// Scroll to top of feed
		if(!automatic) document.location = document.location.toString().split('#')[0] + '#boardlist_header';
	});
}
else
{
...
// Cleans array of empty and duplicate items (insensitive to case and trailing/leading spaces)
function uniq(a)
{
	var seen = {};
	return a.filter((item) =>
	{
		return  (item.trim() == "") ? false :
			seen.hasOwnProperty(item.trim().toLowerCase()) ? false :
			(seen[item.trim().toLowerCase()] = true);
	});
}

function fillGeoblockForm(cr_post, cr_file, prop_post, prop_file, isthread)
{
	if(isthread)
	{
		$('#prop_both').show();
		$('#prop_post').show();
		$('#prop_file').show();
		$('#prop_both_label').show();
		$('#prop_post_label').show();
		$('#prop_file_label').show();
		$('#prop_both').prop('checked', prop_post || prop_file);
		$('#prop_post').prop('checked', prop_post);
		$('#prop_file').prop('checked', prop_file);
	}
	else
	{
		$('#prop_both_label').hide();
		$('#prop_post_label').hide();
		$('#prop_file_label').hide();
		$('#prop_both').hide();
		$('#prop_post').hide();
		$('#prop_file').hide();
	}
	$('#cr_both').val(uniq((cr_post+','+cr_file).split(',')).map(x=>x.trim()).join(','));
	$('#cr_post').val(cr_post);
	$('#cr_file').val(cr_file);
	$('#geoblockform').fadeIn('fast');
}

function geoBlock(elem, board, post, isthread)
{
	$('#geoblockform').css({top: elem.offset().top + elem.height(), left: elem.offset().left});
	$('#cr_board').val(board);
	$('#cr_postid').val(post);
	$.ajax(
	{
		dataType: "json",
		url: ku_boardspath + '/api.php?id=1&method=get_posts_by_id&params={%22board%22:%22' + board + '%22,%22ids%22:[' + post + ']}',
		success: function(data)
		{
			fillGeoblockForm(data.result[post]['cr_post'], data.result[post]['cr_file'], data.result[post]['cr_prop'], data.result[post]['crf_prop'], isthread);
		},
		error: function()
		{
			fillGeoblockForm('?', '?', false, false, isthread);
		}
	});
	return false;
}

function editTags(elem, board, post)
{
	$('#edittagsform').css({top: elem.offset().top + elem.height(), left: elem.offset().left});
	$('#tf_board').val(board);
	$('#tf_postid').val(post);
	$('#tf_parentid').val(elem.parent().parent().parent().find('.span_parent_id').text());
	$.ajax(
	{
		dataType: "json",
		url: ku_boardspath + '/api.php?id=1&method=get_posts_by_id&params={%22board%22:%22' + board + '%22,%22ids%22:[' + post + ']}',
		success: function(data)
		{
			$('#tf_tags').val(data.result[post]['tags']);
			$('#edittagsform').fadeIn('fast');
		},
		error: function()
		{
			$('#tf_tags').val('?');
...
function do_geoblock(is_post, is_file)
{
	board = $('#cr_board').val();
	post = $('#cr_postid').val();
	field = (!is_post) ? 'country_restrict_file' : (!is_file) ? 'country_restrict' : 'both';
	data = $((!is_post) ? '#cr_file' : (!is_file) ? '#cr_post' : '#cr_both').val();
	prop = $((!is_post) ? '#prop_file' : (!is_file) ? '#prop_post' : '#prop_both') .is(':checked');
	$.ajax(
	{
		url: ku_boardspath + '/manage_page.php?action=geoblock&field=' + field + '&board=' + board + '&post=' + post + '&data=' + data + '&propagate=' + (prop ? '1' : '0'),
		success: function()
		{
			popupMessageTmp("Параметры геоблокировки успешно изменены.");
			$('#geoblockform').hide();
		},
		error: function()
		{
			popupMessageTmp("Не удалось изменить параметры геоблокировки!");
			$('#geoblockform').hide();
		}
	});
}

function do_edittags()
{
	board = $('#tf_board').val();
	post = $('#tf_postid').val();
	parent = $('#tf_parentid').val();
	data = $('#tf_tags').val();
	$.ajax(
	{
		url: ku_boardspath + '/manage_page.php?action=settags&board=' + board + '&post=' + post + '&data=' + data,
		success: function()
		{
			popupMessageTmp("Теги успешно изменены.");
			$('#edittagsform').hide();
			$.ajax(
			{
				dataType: "json",
				...
				success: function(data)
				{
					tags = data.result[post]['tags'];
					$('.tags-list-'+board+'-'+post).text((tags == '') ? '' : '#: ' + tags);
				}
			});
			$.ajax(
			{
				dataType: "json",
				url: ku_boardspath + '/api.php?id=1&method=get_posts_by_id&params={%22board%22:%22' + board + '%22,%22ids%22:[' + parent + ']}',
				success: function(data)
				{
					tags = data.result[parent]['tags'];
					$('.tags-list-'+board+'-'+parent).text((tags == '') ? '' : '#: ' + tags);
				}
			});
		},
		error: function()
		{
			popupMessageTmp("Не удалось изменить теги!");
			$('#edittagsform').hide();
		}
	});
}
...
function popupMessageWithLoading(title) {
	popupMessageOn('<table align="center"><tr><td><img src="/images/loading.gif?v='+ku_cssver+'"></td><td valign="center">&nbsp;' + title + '</td></tr></table>');
}
...
function post_preview(e)
{
	...
	$('#post_preview').html('<table align="center"><tbody><tr><td><img src="'+ku_boardspath+'/images/loading.gif?v='+ku_cssver+'"></td><td valign="center">&nbsp;Создаём предпросмотр поста...</td></tr></tbody></table>');
	xhr.send(formData);
...
var PostPreviews = {
  ...
  _mouseover: function(e) {
    ...
    if (PostPreviews.cached[previewid] != null) {  
      ...
      preview.html("<img alt=\"...\" src=\""+ku_boardspath+"/images/loading.gif?v="+ku_cssver+"\" />");
...
function dollchan_indicator_set() {
	...
	$('#boardlist_footer').after('<table align="right" style="position: relative; top: -40px;">' +
		'<tr><td rowspan=2><img src="' + ku_boardspath + imgs[state] + '?v='+ku_cssver+'"></td><td>' + txts[state] + '</td></tr>' +
...
var Settings = {
  ...
  fullfeed: function(changed) {
    var enabled = Settings._checkbox(changed, 'fullfeed', false);

    // First try to process iframes content, and if failed, do it in window
    if (enabled)
    {
      if($("iframe", window.parent.document).each !== undefined)
      {
        $("iframe", window.parent.document).each((x,f) =>
        {
          var href = $(".feedlink", f.contentDocument).attr("href");
          if(href !== undefined) $(".feedlink", f.contentDocument).attr("href", href.replace(/(\?.*)*$/, "?fullfeed"));
        });
      }
      $(".feedlink").attr("href", $(".feedlink").attr("href").replace(/(\?.*)*$/, "?fullfeed"));
    }
    else
    {
      if($("iframe", window.parent.document).each !== undefined)
      {
        ...
        {
          var href = $(".feedlink", f.contentDocument).attr("href");
          if(href !== undefined) $(".feedlink", f.contentDocument).attr("href", href.replaceAll("?fullfeed",""));
        });
      }
      $(".feedlink").attr("href", $(".feedlink").attr("href").replaceAll("?fullfeed",""));
    }

    // Reload if we're currently on feed
    if(changed)
    {
      if(window.location.href.includes("single.php"))
      {
        window.location.href = ku_boardspath + "/single.php" + (enabled ? "?fullfeed" : "");
      }
    }
    return enabled;
  }
...
function setCaptchaLang(lang) {
  captchalang = in_array(lang, ku_captchaenabled.split(',')) ? lang : ku_captchaenabled.split(',')[0];
  setCookie('captchalang', captchalang, 365);
}
setCaptchaLang(getCookie('captchalang'));
...
function readyset() {
  ...
  langlinks = Array();
  if(ku_captchaenabled.split(',').includes('ru')) langlinks.push('<a href="javascript:setCaptchaLang(\'ru\');">Cyrillic</a>');
  if(ku_captchaenabled.split(',').includes('num')) langlinks.push('<a href="javascript:setCaptchaLang(\'num\');">Numeral</a>');
  if(ku_captchaenabled.split(',').includes('en')) langlinks.push('<a href="javascript:setCaptchaLang(\'en\');">English</a>');
  $('#js_settings').prepend(_.captchalang+': '+langlinks.join(' | ')+'<br />');
  ...
  $('<div id="viewlink"></div>').addClass('content-background reflinkpreview qreplyform').html(
    ...
    '<a href="#" onclick="javascript:$(\'#viewlink\').hide();return false;" title="'+_.close+'"><img style="vertical-align: top;" src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" border="0" class="closebox spritebtn"></a>'
  ).hide().appendTo('body');
  $('<div id="geoblockform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    '<form><input type="hidden" id="cr_board" name="cr_board"><input type="hidden" id="cr_postid" name="cr_postid"><div style="display:inline-block">'+
    '<input type="text" size="10" id="cr_both" name="cr_both" title="' + _.isocodes + '"><input type="checkbox" id="prop_both" name="prop_both"><label for="prop_both" id="prop_both_label">' + _.propagate + '</label>&nbsp;&nbsp;<input type="button" style="width: 50px;" name="gbboth" title="' + _.geoblockboth + '" value="' + _.both + '" onclick="do_geoblock(true, true); return false;"><br />'+
    '<input type="text" size="10" id="cr_post" name="cr_post" title="' + _.isocodes + '"><input type="checkbox" id="prop_post" name="prop_post"><label for="prop_post" id="prop_post_label">' + _.propagate + '</label>&nbsp;&nbsp;<input type="button" style="width: 50px;" name="gbpost" title="' + _.geoblockpost + '" value="' + _.post + '" onclick="do_geoblock(true, false); return false;"><br />'+
    '<input type="text" size="10" id="cr_file" name="cr_file" title="' + _.isocodes + '"><input type="checkbox" id="prop_file" name="prop_file"><label for="prop_file" id="prop_file_label">' + _.propagate + '</label>&nbsp;&nbsp;<input type="button" style="width: 50px;" name="gbfile" title="' + _.geoblockfile + '" value="' + _.file + '" onclick="do_geoblock(false, true); return false;"><br />'+
    '</div>&nbsp;&nbsp;<a href="#" onclick="javascript:$(\'#geoblockform\').hide();return false;" title="'+_.close+'"><img style="vertical-align: top;" src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" border="0" class="closebox spritebtn"></a></form>'
  ).hide().appendTo('body');
  $('<div id="edittagsform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    '<form><input type="hidden" id="tf_board" name="tf_board"><input type="hidden" id="tf_postid" name="tf_postid"><input type="hidden" id="tf_parentid" name="tf_parentid"><div style="display:inline-block">'+
    '<input type="text" size="40" id="tf_tags" name="tf_tags" title="' + _.tftags + '">&nbsp;&nbsp;<input type="button" style="width: 50px;" name="tfapply" title="' + _.tfapplynote + '" value="' + _.tfapply + '" onclick="do_edittags(); return false;"><br />'+
    '</div>&nbsp;&nbsp;<a href="#" onclick="javascript:$(\'#edittagsform\').hide();return false;" title="'+_.close+'"><img style="vertical-align: top;" src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" border="0" class="closebox spritebtn"></a></form>'
  ).hide().appendTo('body');
...
var kuadm = getCookie('kuadm');
if (kuadm !== '') {
  if(kuadm === 'admin') kuadm_set = true;
}
...
var nph = {
	...
	prepare: function() {
		...
		if (!this.inited) {
			...
			btnElem.href = "#";
			btnElem.innerHTML = '<img src="/css/icons/blank.gif?v='+ku_cssver+'" class="spritebtn delete" border="0">';
...
function admin_check_reports() {
	...
	xhr.onreadystatechange = function() {
		...
		var count = (text.search("Посмотреть репорты") < 0) ? "" : text.split("Посмотреть репорты [")[1].split("]")[0].replace(/[^0-9]/gi, '');
		if (count == "") {
