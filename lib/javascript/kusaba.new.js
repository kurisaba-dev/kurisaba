...
function readyset() {
  ...
  $('<div id="geoblockform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    ...
    '<input type="text" size="10" id="cr_both" name="cr_both" title="' + _.isocodes + '"><input type="checkbox" id="prop_both" name="prop_both"><label for="prop_both" id="prop_both_label">' + _.propagate + '</label><input type="button" name="gbboth" title="' + _.geoblockboth + '" value="' + _.both + '" onclick="do_geoblock(true, true); return false;"><br />'+
    '<input type="text" size="10" id="cr_post" name="cr_post" title="' + _.isocodes + '"><input type="checkbox" id="prop_post" name="prop_post"><label for="prop_post" id="prop_post_label">' + _.propagate + '</label><input type="button" name="gbpost" title="' + _.geoblockpost + '" value="' + _.post + '" onclick="do_geoblock(true, false); return false;"><br />'+
    '<input type="text" size="10" id="cr_file" name="cr_file" title="' + _.isocodes + '"><input type="checkbox" id="prop_file" name="prop_file"><label for="prop_file" id="prop_file_label">' + _.propagate + '</label><input type="button" name="gbfile" title="' + _.geoblockfile + '" value="' + _.file + '" onclick="do_geoblock(false, true); return false;"><br />'+
