...
function delandbanlinks($scope, force)
{
    ...
    $scope.find('span[id^=dnb]').each(function(index,element)
    {
        ...
        if(!isthread)
        {
            newhtml += '<a href="#" onclick="editTags($(this), \''+boardname+'\', '+postid+', '+isthread+'); return false;" title="'+_.tagbtn+'"><img src="'+ku_boardspath+'/css/icons/blank.gif?v='+ku_cssver+'" class="edittags spritebtn sb-l"><\/a>';
...
function editTags(elem, board, post, isthread)
{
...
function readyset() {
  ...
  $('<div id="edittagsform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    '<form><input type="hidden" id="tf_board" name="tf_board"><input type="hidden" id="tf_postid" name="tf_postid"><div style="display:inline-block">'+
