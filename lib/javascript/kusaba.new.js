...
var embed_class =
{
	...
	[
		...
		{
			src  : 'pleer\\.net/tracks/',
			tgt  : 'pleer.net/tracks/',
			code : '<div style="margin: 0px 20px 0px 0px;"><embed src="http://embedpleer.net/normal/track?id=$3" type="application/x-shockwave-flash" name="plugin" width="578" height="43"></embed></div>'
		}
	],
...
function hide_unwanted_posts(newly_added)
{
	...
	if (typeof localStorage['hidden_posts'] === 'undefined' || localStorage['hidden_posts'] == '') localStorage['hidden_posts']='[]';
	...
	if (typeof localStorage['hidden_authors'] === 'undefined' || localStorage['hidden_authors'] == '') localStorage['hidden_authors']='[]';
...
{
	if (typeof localStorage['hidden_words'] === 'undefined' || localStorage['hidden_words'] == '') localStorage['hidden_words'] = '[]';
