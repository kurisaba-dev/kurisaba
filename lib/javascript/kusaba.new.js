...
function do_geoblock(is_file)
{
	board = $('#cr_board').val();
	post = $('#cr_postid').val();
	field = (is_file) ? 'country_restrict_file' : 'country_restrict';
	data = $((is_file) ? '#cr_file' : '#cr_post').val();
	prop = $((is_file) ? '#prop_file' : '#prop_post') .is(':checked');
	$.ajax(
	{
...
function readyset() {
  ...
  $('<div id="geoblockform"></div>').addClass('content-background reflinkpreview qreplyform').html(
    ...
    '<input type="text" size="10" id="cr_post" name="cr_post" title="' + _.isocodes + '"><input type="checkbox" id="prop_post" name="prop_post"><label for="prop_post" id="prop_post_label">' + _.propagate + '</label><input type="button" name="gbpost" title="' + _.geoblockpost + '" value="' + _.post + '" onclick="do_geoblock(false); return false;"><br />'+
    '<input type="text" size="10" id="cr_file" name="cr_file" title="' + _.isocodes + '"><input type="checkbox" id="prop_file" name="prop_file"><label for="prop_file" id="prop_file_label">' + _.propagate + '</label><input type="button" name="gbfile" title="' + _.geoblockfile + '" value="' + _.file + '" onclick="do_geoblock(true); return false;"><br />'+
